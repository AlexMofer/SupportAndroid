 ...
 */
public class SimplifiedLongArraySet {
    ...
    public boolean add(long value) {
        ...
        if (mArray == null) {
            mArray = new long[]{value};
        } else {
            final long[] array = new long[mArray.length + 1];
    ...
    public long[] toArray() {
        if (mArray == null) {
            ...
            final long[] result = new long[mArray.length];
    ...
    public boolean equals(Object o) {
        ...
        final SimplifiedLongArraySet that = (SimplifiedLongArraySet) o;
